...
4.  Use the `Group`{.interpreted-text role="guilabel"} to show the group
...
8.  `Basic view`{.interpreted-text role="guilabel"} is recommended and
...
10. `Advanced view`{.interpreted-text role="guilabel"} provides greater
