...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--
    This formatter render an iso19139.ca.HNAP record for EC.
  -->
            ...
            <td>
              <div style="min-height:35px; margin-left: 5px" class="pull-right">
                <a class="btn btn-default btn-sm" href="{$urlValue}"
                   title="{concat(/root/gui/strings/View, ' ', $formatValue, ' ', lower-case(/root/gui/schemas/iso19139h.nap/strings/Dataresources_Format), ':&#160;', $nameValue )}">
            ...
            <td>
              ...
              <div style="min-height:35px; margin-left: 5px" class="pull-right">
                <a class="btn btn-default btn-sm pull-right" target="_blank" href="{$urlValue}"
                   title="{concat(/root/gui/strings/View, ' ', $formatValue, ' ', lower-case(/root/gui/schemas/iso19139.ca.HNAP/strings/Dataresources_Format), ':&#160;', $nameValue )}">
