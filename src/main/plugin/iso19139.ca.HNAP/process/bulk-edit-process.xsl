...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0"
                ...
                exclude-result-prefixes="gmd xsl gco srv geonet xsi xs">
  ...
  <xsl:template match="gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification">
    <xsl:copy>
      ...
      <xsl:choose>
        <!-- If status added, but also an empty gmd:status, don't copy the empty in the result -->
        <xsl:when test="$replacements/replacements/replacement[field = $fieldId and searchValue = ':;::;:']">
          <xsl:apply-templates select="gmd:descriptiveKeywords[string(gmd:MD_Keywords/gmd:keyword/gco:CharacterString) and not(string(gmd:MD_Keywords/gmd:thesaurusName/gmd:CI_Citation/@id))]" />
        </xsl:when>
        <xsl:otherwise>
      ...
      <xsl:choose>
        ...
        <xsl:when test="$replacements/replacements/replacement[field = $fieldIdIC and not(string(searchValue))]">
          <xsl:apply-templates select="gmd:descriptiveKeywords[string(gmd:MD_Keywords/gmd:keyword/gco:CharacterString) and (gmd:MD_Keywords/gmd:thesaurusName/gmd:CI_Citation/@id = 'local.theme.EC_Information_Category')]" />
        </xsl:when>
        <xsl:otherwise>
          <xsl:apply-templates select="gmd:descriptiveKeywords[gmd:MD_Keywords/gmd:thesaurusName/gmd:CI_Citation/@id = 'local.theme.EC_Information_Category']" />
        </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
        <xsl:when test="$replacements/replacements/replacement[field = $fieldIdGeo and not(string(searchValue))]">
          <xsl:apply-templates select="gmd:descriptiveKeywords[string(gmd:MD_Keywords/gmd:keyword/gco:CharacterString) and (gmd:MD_Keywords/gmd:thesaurusName/gmd:CI_Citation/@id = 'local.place.EC_Geographic_Scope')]" />
        </xsl:when>
        <xsl:otherwise>
          <xsl:apply-templates select="gmd:descriptiveKeywords[gmd:MD_Keywords/gmd:thesaurusName/gmd:CI_Citation/@id = 'local.place.EC_Geographic_Scope']" />
        </xsl:otherwise>
      </xsl:choose>
      ...
      <xsl:choose>
        ...
        <xsl:when test="$replacements/replacements/replacement[field = $fieldIdFun and not(string(searchValue))]">
          <xsl:apply-templates select="gmd:descriptiveKeywords[string(gmd:MD_Keywords/gmd:keyword/gco:CharacterString) and (gmd:MD_Keywords/gmd:thesaurusName/gmd:CI_Citation/@id = 'local.theme.EC_Data_Usage_Scope')]" />
        </xsl:when>
        <xsl:otherwise>
          <xsl:apply-templates select="gmd:descriptiveKeywords[gmd:MD_Keywords/gmd:thesaurusName/gmd:CI_Citation/@id = 'local.theme.EC_Data_Usage_Scope']" />
      ...
      <xsl:choose>
        ...
        <xsl:when test="$replacements/replacements/replacement[field = $fieldIdCon and not(string(searchValue))]">
          <xsl:apply-templates select="gmd:descriptiveKeywords[string(gmd:MD_Keywords/gmd:keyword/gco:CharacterString) and (gmd:MD_Keywords/gmd:thesaurusName/gmd:CI_Citation/@id = 'local.theme.EC_Content_Scope')]" />
        </xsl:when>
        <xsl:otherwise>
          <xsl:apply-templates select="gmd:descriptiveKeywords[gmd:MD_Keywords/gmd:thesaurusName/gmd:CI_Citation/@id = 'local.theme.EC_Content_Scope']" />
        </xsl:otherwise>
      </xsl:choose>
  ...
  <xsl:template match="gmd:MD_Metadata/gmd:identificationInfo/gmd:MD_DataIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords[not(string(gmd:thesaurusName/gmd:CI_Citation/@id))]|
                       gmd:MD_Metadata/gmd:identificationInfo/*[@gco:isoType='gmd:MD_DataIdentification']/gmd:descriptiveKeywords/gmd:MD_Keywords[not(string(gmd:thesaurusName/gmd:CI_Citation/@id))]|
                       gmd:MD_Metadata/gmd:identificationInfo/srv:SV_ServiceIdentification/gmd:descriptiveKeywords/gmd:MD_Keywords[not(string(gmd:thesaurusName/gmd:CI_Citation/@id))]|
                       gmd:MD_Metadata/gmd:identificationInfo/*[@gco:isoType='srv:SV_ServiceIdentification']/gmd:descriptiveKeywords/gmd:MD_Keywords[not(string(gmd:thesaurusName/gmd:CI_Citation/@id))]">
