...
<xsl:stylesheet version="2.0" xmlns:xsl ="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- ===================================================================== -->
  <!-- === iso19139.ca.HNAP brief formatting 							   === -->
  <!-- ===================================================================== -->
  <xsl:template name="iso19139.ca.HNAPBrief">
    <metadata>
      <xsl:choose>
        ...
        <xsl:otherwise>
          ...
          <xsl:call-template name="iso19139.ca.HNAP-brief"/>
        </xsl:otherwise>
      </xsl:choose>
    </metadata>
  </xsl:template>
  ...
  <xsl:template name="iso19139.ca.HNAP-brief">
