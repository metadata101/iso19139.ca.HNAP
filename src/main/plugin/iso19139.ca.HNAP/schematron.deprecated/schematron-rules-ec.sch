...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
  ...
  <xsl:function name="geonet:resourceFormatsList" as="xs:string">
    ...
    <xsl:variable name="formats-list" select="document(concat('file:///', replace(concat($thesaurusDir, '/local/thesauri/theme/GC_Resource_Formats.rdf'), '\\', '/')))"/>
  ...
  <sch:pattern>
    ...
    <sch:rule context="//gmd:identificationInfo/*/gmd:citation/*/gmd:citedResponsibleParty/*/gmd:organisationName
      ...
      <sch:let name="government-titles" value="document(concat('file:///', replace(concat($thesaurusDir, '/local/thesauri/theme/GC_Government_Titles.rdf'), '\\', '/')))"/>
    ...
    <sch:rule context="//gmd:identificationInfo/*/gmd:citation/*/gmd:citedResponsibleParty//gmd:country
	  ...
	  <sch:let name="country-values" value="document(concat('file:///', replace(concat($thesaurusDir, '/local/thesauri/theme/ISO_Countries.rdf'), '\\', '/')))"/>
  ...
  <sch:pattern>
    ...
    <sch:rule context="//gmd:distributionInfo/*/gmd:distributor/gmd:MD_Distributor/gmd:distributorContact/*/gmd:organisationName">
      ...
      <sch:let name="government-titles" value="document(concat('file:///', replace(concat($thesaurusDir, '/local/thesauri/theme/GC_Departments.rdf'), '\\', '/')))"/>
    ...
    <sch:rule context="//gmd:distributionInfo/*/gmd:distributionFormat/*/gmd:name">
      ...
      <sch:let name="distribution-formats" value="document(concat('file:///', replace(concat($thesaurusDir, '/local/thesauri/theme/GC_Resource_Formats.rdf'), '\\', '/')))"/>
    ...
    <sch:rule context="//gmd:distributionInfo/gmd:MD_Distribution/gmd:transferOptions/gmd:MD_DigitalTransferOptions/gmd:onLine">
      <sch:let name="smallcase" value="'abcdefghijklmnopqrstuvwxyz'" />
      <sch:let name="uppercase" value="'ABCDEFGHIJKLMNOPQRSTUVWXYZ'" />
	  <sch:let name="formats-list" value="document(concat('file:///', replace(concat($thesaurusDir, '/local/thesauri/theme/GC_Resource_Formats.rdf'), '\\', '/')))"/>
