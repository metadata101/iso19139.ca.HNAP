...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!--
    This formatter render an iso19139.napec record for EC.
  -->
      ...
      <xsl:call-template name="showPanel">
        ...
        <xsl:with-param name="content">
          <table class="sidebar" style="table-layout:fixed; width:99% !important; word-wrap: break-word;">
            <tbody>
              <xsl:apply-templates mode="render-field" select="/root/gmd:MD_Metadata//gmd:identificationInfo/*/gmd:descriptiveKeywords[gmd:MD_Keywords/@id='classification-theme']" />


              <xsl:apply-templates mode="render-field" select="/root/gmd:MD_Metadata//gmd:identificationInfo/*/gmd:descriptiveKeywords[gmd:MD_Keywords/@id='classification-subtheme']" />

              <!-- keywords (no thesaurus) -->
              ...
              <xsl:for-each-group select="/root/gmd:MD_Metadata/gmd:identificationInfo/*/gmd:descriptiveKeywords[
                not(string(normalize-space(gmd:MD_Keywords/gmd:thesaurusName/gmd:CI_Citation/gmd:title/gco:CharacterString)))]" group-by="gmd:MD_Keywords/gmd:type/gmd:MD_KeywordTypeCode/@codeListValue">
              ...
              <xsl:apply-templates mode="render-field" select="/root/gmd:MD_Metadata//gmd:identificationInfo/*/gmd:descriptiveKeywords[contains(*/gmd:thesaurusName/gmd:CI_Citation/gmd:title/gco:CharacterString, 'EC_Information_Category')]" />

              <xsl:apply-templates mode="render-field" select="/root/gmd:MD_Metadata//gmd:identificationInfo/*/gmd:descriptiveKeywords[contains(*/gmd:thesaurusName/gmd:CI_Citation/gmd:title/gco:CharacterString, 'EC_Content_Scope')]" />


              <xsl:apply-templates mode="render-field" select="/root/gmd:MD_Metadata//napec:EC_Branch" />

              <xsl:apply-templates mode="render-field" select="/root/gmd:MD_Metadata//napec:EC_Directorate" />

              <xsl:apply-templates mode="render-field" select="/root/gmd:MD_Metadata//napec:EC_Project" />

              <xsl:apply-templates mode="render-field" select="/root/gmd:MD_Metadata//napec:GC_Security_Classification" />
            ...
            <td>
              <div style="min-height:35px; margin-left: 5px" class="pull-right">
                <a class="btn btn-default btn-sm" href="{$urlValue}"
                   title="{concat(/root/gui/strings/View, ' ', $formatValue, ' ', lower-case(/root/gui/schemas/iso19139.napec/strings/Dataresources_Format), ':&#160;', $nameValue )}">
