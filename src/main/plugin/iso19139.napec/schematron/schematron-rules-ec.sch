...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron"
  ...
  <!-- Title -->
  <sch:pattern>
    <sch:title>$loc/strings/ECTitle</sch:title>
  ...
  <!-- Language -->
  <sch:pattern>
    <sch:title>$loc/strings/ECDatasetLanguage</sch:title>
  ...
  <sch:pattern>
    <sch:title>$loc/strings/CitedResponsiblePartyOrganisation</sch:title>
  ...
  <sch:pattern>
    <sch:title>$loc/strings/CitedResponsiblePartyIndividualName</sch:title>
  ...
  <sch:pattern>
    <sch:title>$loc/strings/CitedResponsiblePartyEmail</sch:title>
  ...
  <!--<sch:pattern>
       <sch:title>$loc/strings/EC5</sch:title>

       <sch:rule context="//gmd:identificationInfo/*/gmd:descriptiveKeywords/gmd:MD_Keywords[gmd:thesaurusName/gmd:CI_Citation/@id = 'local.theme.EC_Data_Usage_Scope']">

           <sch:let name="missing" value="not(string(gmd:keyword))" />

           <sch:assert
               test="not($missing)"
               >$loc/strings/EC5</sch:assert>
  ...
  <sch:pattern>
    <sch:title>$loc/strings/DistributorOrganisation</sch:title>
  ...
  <sch:pattern>
    <sch:title>$loc/strings/DistributorEmail</sch:title>
  ...
  <!-- Distributor - Role -->
  <sch:pattern>
    <sch:title>$loc/strings/DistributorRole</sch:title>
