				...
				<gmd:URL>
					<xsl:choose>
						<xsl:when test="/root/env/config/downloadservice/simple='true'">
                            ...
                            <xsl:choose>
                                <xsl:when test="string($fnameInUrl)">
                                    <xsl:value-of select="concat(/root/env/siteURL,'/resources.get?id=',/root/env/id,'&amp;fname=',$fnameInUrl,'&amp;access=private')"/>
                                </xsl:when>
                                <xsl:when test="string($fname)">
						...
						<xsl:when test="/root/env/config/downloadservice/withdisclaimer='true'">
                            <xsl:choose>
                                <xsl:when test="string($fnameInUrl)">
                                    <xsl:value-of select="concat(/root/env/siteURL,'/file.disclaimer?id=',/root/env/id,'&amp;fname=',$fnameInUrl,'&amp;access=private')"/>
                                </xsl:when>
                                <xsl:when test="string($fname)">
