...
<xsl:stylesheet version="2.0" xmlns:xsl ="http://www.w3.org/1999/XSL/Transform"
        ...
        <xsl:for-each select="gmd:distributionInfo/gmd:MD_Distribution|gmd:distributionInfo/*[@gco:isoType='gmd:MD_Distribution']">
          ...
          <xsl:call-template name="complexElementGuiWrapper">
            ...
            <xsl:with-param name="content">
              ...
              <xsl:call-template name="complexElementGuiWrapper">
                <xsl:with-param name="title" select="/root/gui/schemas/iso19139.napec/labels/element[@name='gmd:distributorContact']/label"/>
                <xsl:with-param name="content">
              ...
              <tr>
                <td>
                  <h4 title="{/root/gui/schemas/iso19139.napec/strings/MapResourcesDesc}">
                    <span class="btn btn-success pull-right btn-xs" onclick="dataDepositMap.showAddMapServiceResource()">
                      <span class="glyphicon glyphicon-plus"></span>&#160;<xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/AddMapServiceResource" /></span>
                    <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/MapResources" /></h4>

                  <xsl:variable name="refResources" select="geonet:element/@ref" />

                  <p><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/MapResourcesDesc" /></p>
              ...
              <tr>
                <td>
                  <table class="table table-striped" id="mapservice-resources-table" style="width:100%">
                    <thead>
                      <tr>
                        <th style="min-width:10px"><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_RCS" /></th>
                        <th style="min-width:100px"><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Service" /></th>
                        <th style="min-width:100px"><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Layer" /></th>
                        <th style="min-width:100px"><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Description" /></th>
                        <th style="min-width:100px"><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Protocol" /></th>
                        <th style="min-width:100px"><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Language" /></th>
              ...
              <tr>
                <td>
                  ...
                  <h4 title="{/root/gui/schemas/iso19139.napec/strings/DataresourcesDesc}">
                    <span role="button" class="btn btn-success pull-right btn-xs" onclick="dataDeposit.showAddDataResource()">
                      <span class="glyphicon glyphicon-plus"></span>&#160;<xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/AddDataResource" /></span>
                    <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources" />
                  </h4>
                  <p><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/DataresourcesDesc" /></p>
                </td>
              </tr>
              <tr>
                <td>
                  <table class="table table-striped" id="data-resources-table">
                    <thead>
                      <tr>
                        <th><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Name" /></th>
                        <th><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Description" /></th>
                        <th><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Protocol" /></th>
                        <th>&#160;</th>
                      </tr>
                    </thead>
                    <tbody>
  ...
  <xsl:template name="iso19139GetIsoLanguageEC" mode="iso19139GetIsoLanguage" match="*" priority="30">
    ...
    <xsl:variable name="tooltip">
      <xsl:call-template name="getTooltipTitle-iso19139.nap">
        <xsl:with-param name="name"   select="name(.)"/>
        <xsl:with-param name="schema" select="$schema"/>
      </xsl:call-template>
    </xsl:variable>
          ...
          <xsl:otherwise>
            <select class="md" name="{$ref}" size="1" title="{$tooltip}">
              ...
              <option value="eng; CAN">
                ...
                <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/english" />
              </option>
              ...
              <option value="fra; CAN">
                ...
                <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/french" />
              </option>
            </select>
          </xsl:otherwise>
        </xsl:choose>
  ...
  <xsl:template mode="iso19139" match="gmd:country[gco:CharacterString]" priority="1">
    ...
    <xsl:apply-templates mode="simpleElement" select=".">
      ...
      <xsl:with-param name="text">
        <xsl:variable name="mainLang"
                      select="substring(string(/root/*/gmd:language/gco:CharacterString|/root/*/gmd:language/gmd:LanguageCode/@codeListValue), 1, 3)" />
          ...
          <xsl:when test="$edit=true()">
            ...
            <select class="form-control" name="_{gco:CharacterString/geonet:element/@ref}"
              ...
              <optgroup label="{$canLabel}">
                <xsl:for-each select="/root/gui/schemas/iso19139.napec/strings/adminAreas/area[@country='CAN']">
              ...
              <optgroup label="{$usaLabel}">
                <xsl:for-each select="/root/gui/schemas/iso19139.napec/strings/adminAreas/area[@country='USA']">
                  <xsl:variable name="areaEng" select="@eng" />
                  <xsl:variable name="areaFre" select="@fre" />
                  <option>
                    <xsl:attribute name="value"><xsl:value-of select="@eng"/></xsl:attribute>
...
-->
    ...
    <xsl:choose>
      ...
      <xsl:otherwise>
        ...
        <xsl:variable name="textValue">
          <xsl:value-of select="gco:DateTime|gco:Date" /> <xsl:text> (</xsl:text><xsl:value-of select="/root/gui/schemas/iso19139.napec/codelists/codelist[@name='gmd:CI_DateTypeCode']/entry[code = $dateTypeCode]/label "/><xsl:text>)</xsl:text>
        </xsl:variable>
  ...
  <xsl:template mode="iso19139" match="gmd:transferOptions/gmd:MD_DigitalTransferOptions" priority="100">
    ...
    <xsl:if test="count(gmd:onLine) &gt; 0">
      ...
      <p><strong><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/resources" /></strong></p>
      <ul>
