        ...
        <fo:block>
              ...
              <xsl:if test="(/root/gmd:MD_Metadata//gmd:EX_GeographicBoundingBox/gmd:westBoundLongitude/gco:Decimal!='') and number(/root/gmd:MD_Metadata//gmd:EX_GeographicBoundingBox/gmd:westBoundLongitude/gco:Decimal)!=0 and
                ...
                <xsl:call-template name="TRFop">
                  <xsl:with-param name="label">
                    <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/GeographicExtent"/>
                  </xsl:with-param>
                  <xsl:with-param name="text">
                    <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/sw"/>:<xsl:value-of
                    ...
                    <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/ne"/>:<xsl:value-of
            ...
            <fo:table width="100%" table-layout="fixed">
              ...
              <fo:table-body>
                ...
                <xsl:for-each
                  ...
                  <xsl:call-template name="TRFop">
                    <xsl:with-param name="label">
                      <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Timeperiod"/>
                    </xsl:with-param>
                    <xsl:with-param name="text">

                      <xsl:choose>
                        <xsl:when test="gml:beginPosition or gml:endPosition">
                      <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/from"/>:<xsl:value-of select="gml:beginPosition"/> -
                      <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/to"/>:<xsl:value-of select="gml:endPosition"/>
                        </xsl:when>
                        <xsl:when test="gml:begin or gml:end">

                          <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/from"/>:<xsl:value-of select="gml:begin/gml:TimeInstant/gml:timePosition"/> -
                          <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/to"/>:<xsl:value-of select="gml:end/gml:TimeInstant/gml:timePosition"/>
                        </xsl:when>
                      </xsl:choose>
                    </xsl:with-param>
                  </xsl:call-template>
          ...
          <xsl:if
            ...
            <fo:block font-weight="bold" font-size="10pt" padding-top="4pt" padding-bottom="4pt" padding-left="4pt"
                      padding-right="4pt">
                <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources"/>
            </fo:block>
              ...
              <fo:block font-size="10pt" padding-top="4pt" padding-bottom="4pt" padding-left="4pt"
                ...
                <fo:table border="none" table-layout="fixed" width="100%">
                  ...
                  <fo:table-header>
                    <fo:table-cell>
                      <fo:block font-weight="bold"><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Name" /></fo:block>
                    </fo:table-cell>
                    <fo:table-cell>
                      <fo:block font-weight="bold"><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Type" /></fo:block>
                    </fo:table-cell>
                    <fo:table-cell>
                      <fo:block font-weight="bold"><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Lang" /></fo:block>
                    </fo:table-cell>
                    <fo:table-cell>
                      <fo:block font-weight="bold"><xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataresources_Format" /></fo:block>
                    </fo:table-cell>
                  </fo:table-header>
          ...
          <fo:block font-weight="bold" font-size="10pt" padding-top="4pt" padding-bottom="4pt" padding-left="4pt"
                    padding-right="4pt">
            <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Additionalinformation"/>
          </fo:block>
                ...
                <fo:table-row background-color="#1b5a9f">
                  <fo:table-cell padding-left="4pt" padding-right="4pt" padding-top="4pt" margin-top="4pt"
                    ...
                    <fo:block color="#ffffff" font-weight="bold" font-size="10pt">
                      <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Datasetidentification"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
              ...
              <fo:table-body>
                <fo:table-row background-color="#1b5a9f">
                  <fo:table-cell padding-left="4pt" padding-right="4pt" padding-top="4pt" margin-top="4pt"
                                 number-columns-spanned="2" display-align="center">
                    <fo:block color="#ffffff" font-weight="bold" font-size="10pt">
                        <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/DistributionInformation"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
                  ...
                  <xsl:call-template name="blockElementFop">
                    ...
                    <xsl:with-param name="label" select="/root/gui/schemas/iso19139.napec/labels/element[@name='gmd:distributionFormat']/label" />
                    <xsl:with-param name="width-label" select="'5cm'" />
                    <xsl:with-param name="width-content" select="'6.8cm'" />
                  </xsl:call-template>
                </xsl:for-each>
          ...
          <xsl:if test="gmd:dataQualityInfo/*">
            ...
            <xsl:call-template name="sectionBlock">
              <xsl:with-param name="headerLabel" select="/root/gui/schemas/iso19139.napec/labels/element[@name='gmd:dataQualityInfo']/label" />
          ...
          <xsl:if test="gmd:portrayalCatalogueInfo/*">
            <fo:block margin-top="12pt"/>
            <xsl:call-template name="sectionBlock">
              <xsl:with-param name="headerLabel" select="/root/gui/schemas/iso19139.napec/labels/element[@name='gmd:portrayalCatalogueInfo']/label" />
              <xsl:with-param name="content">
          ...
          <xsl:if test="gmd:metadataConstraints/*">
            <fo:block margin-top="12pt"/>
            <xsl:call-template name="sectionBlock">
              <xsl:with-param name="headerLabel" select="/root/gui/schemas/iso19139.napec/labels/element[@name='gmd:metadataConstraints']/label" />
              <xsl:with-param name="content">
          ...
          <xsl:if test="gmd:applicationSchemaInfo/*">
            <fo:block margin-top="12pt"/>
            <xsl:call-template name="sectionBlock">
              <xsl:with-param name="headerLabel" select="/root/gui/schemas/iso19139.napec/labels/element[@name='gmd:applicationSchemaInfo']/label" />
              <xsl:with-param name="content">
          ...
          <xsl:if test="gmd:metadataMaintenance/*">
            <fo:block margin-top="12pt"/>
            <xsl:call-template name="sectionBlock">
              <xsl:with-param name="headerLabel" select="/root/gui/schemas/iso19139.napec/labels/element[@name='gmd:metadataMaintenance']/label" />
              <xsl:with-param name="content">
              ...
              <fo:table-body>
                <fo:table-row background-color="#1b5a9f">
                  <fo:table-cell padding-left="4pt" padding-right="4pt" padding-top="4pt" margin-top="4pt"
                                 number-columns-spanned="2" display-align="center">
                    <fo:block color="#ffffff" font-weight="bold" font-size="10pt">
                      <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Metadatarecord"/>
                    </fo:block>
                  </fo:table-cell>
                </fo:table-row>
          ...
          <xsl:if test="gmd:metadataExtensionInfo/*">
            ...
            <xsl:call-template name="sectionBlock">
              <xsl:with-param name="headerLabel" select="/root/gui/schemas/iso19139.napec/labels/element[@name='gmd:metadataExtensionInfo']/label" />
              <xsl:with-param name="content">
                ...
                <fo:table-body>
                  <fo:table-row background-color="#1b5a9f">
                    <fo:table-cell padding-left="4pt" padding-right="4pt" padding-top="4pt" margin-top="4pt"
                                   number-columns-spanned="2" display-align="center">
                      <fo:block color="#ffffff" font-weight="bold" font-size="10pt">
                        <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Thumbnail"/>
                      </fo:block>
                    </fo:table-cell>
                  </fo:table-row>
            ...
            <fo:table-body>
              <fo:table-row background-color="#1b5a9f">
                <fo:table-cell padding-left="4pt" padding-right="4pt" padding-top="4pt" margin-top="4pt"
                  ...
                  <fo:block color="#ffffff" font-weight="bold" font-size="10pt">
                    ...
                    <xsl:value-of select="/root/gui/schemas/iso19139.napec/strings/Dataclassification"/>
              ...
              <xsl:variable name="keywordsList">
                ...
                <xsl:if test="string($keywordsListNorm)">
                  <xsl:call-template name="TRFop">
                    <xsl:with-param name="label">
                      <xsl:value-of select="/root/gui/schemas/iso19139.napec/labels/element[@name='CoreSubjectThesaurus']/label" />
                    </xsl:with-param>
                    <xsl:with-param name="text">
                      <xsl:value-of select="substring($keywordsListNorm, 1, string-length($keywordsListNorm) - 1)" />
                    </xsl:with-param>
